...
const apiKey = import.meta.env.PUBLIC_LASTFM_API_KEY || 'b25b959554ed76058ac220b7b2e0a026';
---
...
The example uses Last.fm's demo API key as a fallback. For production use:
